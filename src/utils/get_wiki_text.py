...
if __name__ == "__main__":
    ...
    for file in files:
        ...
        with open(args.output_directory + file[:-6] + 'txt', 'w', encoding='utf-8') as out_file:
            print(file)
            file_iter = 0
            if '-wikipedia' in file:
                with lzma.open(args.input_directory + file, 'rt', encoding='utf-8') as f:
